...
module.exports = {
	// Project Identity
	appName: 'chemieZijePlugin', // Unique name of your project
	type: 'plugin', // Plugin or theme
	slug: 'chemie-zije-plugin', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'chemieZijePlugin',
		author: '',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
